...
* Adjustable damage multipliers (weapon-specific) 🎯
...
```mermaid
flowchart LR
    A[Start Game] --> B[Attach Trainer]
    B --> C[Detect Game Version]
    C --> D[Load Feature Modules]
    D --> E[Apply User Preset]
    E --> F[Real-Time Hunt Adjustments]
```
